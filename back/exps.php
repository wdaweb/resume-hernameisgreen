            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><button type="button" class="btn edit-bio-btn" data-bs-toggle="modal" data-bs-target="#edit-bio-<?= $row['id'] ?>">編輯</button>
                            <!-- Modal -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="api/edit_bio.php" method="post">
                                            ...
                                            <div class="modal-body d-flex flex-column justify-content-between">
                                                ...
                                                <p class="mt-1">請輸入自傳內容: </p>
                                                <textarea name="bio" id="bio" cols="60" rows="30"> <?= $row['bio'] ?></textarea>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary cancel-btn" data-bs-dismiss="modal">取消</button>
